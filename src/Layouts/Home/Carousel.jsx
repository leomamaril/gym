            ...
            <Container variant='primary'>
                <SubContainer >
                    <div className="row align-items-end g-0 gy-3">
                        <div className="col-12 col-md-12 order-1 order-md-1">
                            ...
                            <div className="d-flex flex-column flex-md-row gap-3">
                                <p className="font-p poppins mb-0 flex-grow-1">{WORKOUT.body}</p>
                        ...
                        <div className="carousel-track ">
                            {visibleItems.map((item, index) => (
                                <div key={index} className="card text-white bg-transparent" >
                                    <img src={item.img} className="card-img-top h-100" alt={item.title} />
                                    <div className="card-body">
                                        <h5 className="font-class card-title text-base bebas mt-3">{item.title}</h5>
                                        <p className="font-p card-text poppins">{item.body}</p>
                                        <a href="#" className="font-btn text-base bebas">{item.discover}</a>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="d-none d-sm-block">
                        <div className="d-flex gap-3 w-100 justify-content-center my-4">
                            <button className="btn-gymfit-primary text-center px-5 bebas font-btn">View All Classes</button>
                        </div>
                    </div>
