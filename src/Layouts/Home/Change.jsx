                    ...
                    <div className="row justify-content-center text-center g-0 gy-3">
                        <div className="col-12 d-flex flex-column align-items-center d-none d-sm-block">
                            ...
                            <div className="d-flex flex-row gap-3 justify-content-center py-5">
                                <button className="btn-gymfit-primary font-btn">{CHANGE.btn1}</button>
                                <button className="btn-gymfit-outline font-btn">{CHANGE.btn2}</button>
                            </div>
                        </div>
                        ...
                        <div className="col-12 d-flex flex-column align-items-center d-sm-none">
                            ...
                            <div className="d-flex flex-row w-100 gap-2 py-3">
                                <button className="btn-gymfit-primary w-75 font-btn">{CHANGE.btn1}</button>
                                <button className="btn-gymfit-outline w-100 font-btn">{CHANGE.btn2}</button>
                            </div>
                        </div>
                    </div>
                </SubContainer>
